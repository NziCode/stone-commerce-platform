            ...
            Forms\Components\Tabs::make()->tabs([
                    ...
                    Forms\Components\Grid::make(2)->schema([
                        Forms\Components\Select::make('template')
                            ...
                            ->options([
                                ...
                                'sidebar'    => 'با سایدبار',
                                'contact'    => 'تماس با ما',
                                'about'      => 'درباره ما (صفحهٔ کامل و خلاقانه)',
                                'profile'    => 'معرفی شخص (مالک/مدیر گروه)',
                                'guide'      => 'راهنمای مرحله‌ای (راهنمای خرید، روش پرداخت، ...)',
                            ])
                            ->helperText('«درباره ما»: صفحهٔ ویژه با بخش داستان، آمار، محصولات، گزارش نمایشگاه، مالک گروه و نشانی‌ها — عنوان، خلاصه و متن از همین صفحه، آمار و نشانی از تنظیمات، تصویر بالای صفحه = «کاور»، تصاویر بخش داستان = «گالری» (تب تصاویر). «معرفی شخص»: نام در عنوان، سمت در خلاصه، معرفی در متن و عکس پرتره در «کاور»؛ این صفحه در بخش «مالک گروه» صفحهٔ درباره ما هم نمایش داده می‌شود. «راهنمای مرحله‌ای»: در متن صفحه یک مقدمه بنویسید، سپس یک «فهرست شماره‌دار» که هر مورد با یک عبارت پررنگ (عنوان مرحله) شروع می‌شود، و در پایان در صورت نیاز یادداشت؛ هر مورد فهرست یک مرحلهٔ تصویری می‌شود و کنار آن دکمه‌های واتساپ و تماس نمایش داده می‌شود.')
                            ->default('default')
                            ->required(),
                ...
                Forms\Components\Tabs\Tab::make('تصاویر')->schema([
                    Forms\Components\SpatieMediaLibraryFileUpload::make('cover')
                        ...
                        ->image()
                        ->imageEditor()
                        ->helperText('در قالب «درباره ما»: تصویر پس‌زمینهٔ بالای صفحه. در قالب «معرفی شخص»: عکس پرتره.')
                        ->columnSpanFull(),
